...
\begin{frame}
  ...
  Alternative to function default label -- join of parameters
  \begin{itemize}
    \item Constraints for calls
    \item Constraints for return statements
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \scalebox{1}{\input{figures/ta_bill_calculator.tikz}}
\end{frame}
