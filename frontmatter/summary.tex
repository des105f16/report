...
The tool itself was written in C\#, employing the SablePP toolbox\footnote{\url{https://github.com/deaddog/SablePP}} to generate the compiler, which allows for easy extensibility.
