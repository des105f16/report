...
\ctrule {PROG-VAR-DECL-EXPR}
        ...
        {fun \vdash \argpart{T \, l \, x \tk = e, lbl}{}{(lbl_1, cstr)}}
        {}
\ctrule {PROG-VAR-DECL}
        {\argpart {T \, l \, x, lbl, fun} {P} {(lbl_1, cstr, fun)} }
        {fun \vdash \argpart{T \, l \, x, lbl}{}{(lbl_1, cstr)}}
        {}
\end{trules}
...
\ctrule {FUNC-DECL}
        ...
        {\argpart{fun_1 \vdash S, lbl_2}{}{(lbl_3, cstr)}}
...
\subsubsection{Statements}
  ...
  \trule{STM-EMPTY}
        {\argpart{\varepsilon, lbl}{}{(lbl, \emptyset)}}
        {}
  \ctrule{STM-EXPR}
        {\argpart{e, lbl}{}{(lbl, cstr)}}
        {lbl \vdash e \rightarrow_e (cstr, l_e)}
        {}
  \ctrule{STM-COMP}
        {\argpart{S_1 \; S_2, lbl}{}{(lbl_2, cstr_1 \cup cstr_2)}}
        {\argpart{S_1, lbl}{}{(lbl_1, cstr_1)} \quad
          \argpart{S_2, lbl_1}{}{(lbl_2, cstr_2)}}
        {}
  \ctrule{STM-WHILE}
        {\argpart{\tk{while} \tk ( e \tk ) S}{}{(lbl, cstr_1 \cup cstr_2 \cup \{ c \})}}
        {lbl_1 \vdash e \rightarrow_e (cstr_1, l_e) \quad
          \argpart{S, lbl_1}{}{(lbl_2, cstr_2)}}
        {where $l_\ib = lbl \, \ib$ \\
          and $l_w = next$ \\
          and $lbl_1 = lbl[\ib \mapsto l_w]$ \\
          and $c = " \, l_e \sqcup l_\ib \sqsubseteq l_w \, "$}
  \ctrule{STM-IF}
        {\argpart{\tk{if} \tk ( e \tk ) S, lbl}{}{(lbl, cstr_1 \cup cstr_2 \cup \{ c \})}}
        {lbl \vdash e \rightarrow_e (cstr_1, l_e) \quad
          \argpart{S, lbl[\ib \mapsto l_{if}]}{}{(lbl_1, cstr_2)}}
        {where $l_\ib = lbl \, \ib$ \\
          and $l_{if} = next$ \\
          and $c = " \, l_e \sqcup l_\ib \sqsubseteq l_{if} \, "$}
  \ctrule{STM-IF-ELSE}
        {\argpart{\tk{if} \tk ( e \tk ) S_1 \tk{else} S_2, lbl}{}{(lbl, cstr_1 \cup cstr_2 \cup cstr_3 \cup \{ c \})}}
        {lbl \vdash e \rightarrow_e (cstr_1, l_e) \quad
          \argpart{S_1, lbl_1}{}{(lbl_2, cstr_2)} \quad
          \argpart{S_2, lbl_1}{}{(lbl_3, cstr_3)}}
          {where $l_\ib = lbl \, \ib$ \\
            and $l_{if} = next$ \\
            and $lbl_1 = lbl[\ib \mapsto l_{if}]$ \\
            and $c = " \, l_e \sqcup l_\ib \sqsubseteq l_{if} \, "$}
  \ctrule{STM-ASS}
        {\argpart{x \tk = e, lbl}{}{(lbl, cstr \cup \{ c \})}}
        {lbl \vdash e \rightarrow_e (cstr, l_e)}
        {where $l_\ib = lbl \, \ib$ \\
          and $c = " \, l_e \sqcup l_\ib \sqsubseteq l_x \, "$ }
  \ctrule{STM-RET-EXPR}
        {\argpart{\tk{return} e, lbl}{}{(lbl, cstr \cup \{ c \})}}
        {lbl \vdash e \rightarrow_e (cstr, l_e)}
        {where $l_\ib = lbl \, \ib$ \\
          and $l_\ifb = lbl \, \ifb$ \\
          and $c = " \, l_e \sqcup l_\ib \sqsubseteq l_\ifb \, "$}
  \trule{STM-RET}
        {\argpart{\tk{return}, lbl}{}{(lbl, \emptyset)}}
        {}
  \ctrule{STM-ACTS-THIS}
        {\argpart{\tk{this} \tk{-->?} p_1 \tk , p_2 \tk , \dots \tk , p_n \; S, lbl}{}{(lbl, cstr)}}
        {\argpart{S, lbl[\ia \mapsto l_\ia']}{}{(lbl_1, cstr)}}
        {where $l_\ia = lbl \, \ia$ \\
          and $l_\ia' = l_\ia \sqcup \mathlarger\sqcupl_{i=1}^n \, \{ p_i \rightarrow \emptyset \}$}
    \ctrule{STM-ACTS-CALLER}
        {\argpart{\tk{caller} \tk{-->?} p_1 \tk , p_2 \tk , \dots \tk , p_n \; S, lbl}{}{(lbl, cstr)}}
        {\argpart{S, lbl[\ia \mapsto l_\ia']}{}{(lbl_1, cstr)}}
        {where $l_\ia = lbl \, \ia$ \\
          and $l_\ia' = l_\ia \sqcup \mathlarger\sqcupl_{i=1}^n \, \{ p_i \rightarrow \emptyset \}$}
