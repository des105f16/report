...
\begin{align*}
  \Gamma_{L} & = (\iDecv \times \iLbl) \cup (\iDecf \times \iLbl) \cup (\iDecpar \times \iLbl) \cup \iLbl \\
  T_{L} & = \iLbl
\end{align*}
...
\begin{align*}
  \Gamma_e =  & \;      \iExp \cup \iExpl \cup \mathbb{L} \\
  T_e =       & \; \mathbb{L}
\end{align*}
Where transitions are of the form $lbl \vdash e \rightarrow_e l \; | \; l \in \mathbb{L}$.
