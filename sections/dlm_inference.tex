...
\begin{trules}
  \trule{FUN-DECL-EXPL}
        ...
        {\argpart {D_P, lbl} {L} {lbl''} \;\; \argpart {D_F, lbl''[f \mapsto l, \ifb \mapsto l, \ib \mapsto \bot]} {L} {lbl'} }
        {where $l \in \mathbb{L}$}
  \trule{FUN-DECL-IMPL}
        {\argpart {T \, l \, f \tk ( D_P \tk ) S, lbl} {L} {lbl'} }
        {\argpart {D_P, lbl} {L} {lbl''} \; \argpart {D_F, lbl''[f \mapsto l', \ifb \mapsto l, \ib \mapsto \bot]} {L} {lbl'} }
...
\begin{trules}
  \trule{WHILE}
        {lbl \vdash \argpart {\tk{while} \tk ( e \tk ) S, cstr} {C} {cstr'} }
        {lbl \vdash \argpart {S_C, cstr[\mapsto c]} {C} {cstr'} }
        {where $while_i$ is the next while block label name\\
