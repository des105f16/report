...
In the rules below a function $principal$ is used to represent the lookup of principal names in some system.
\mikkel{Is this an acceptable explanation?}
\rene{Ja, men jeg tror I skal finde et sted tidligt i rapporten og forklare hvorfor I ikke har principal hierarchy med og hvorfor det er ok}
...
\end{table}
\mikaelin{Fix weird latex that won't use the semeq command.}
