...
\mikael{This sounds like something that needs further explaining. :)}
\rene{Pointer guidelines/styleguide for sikre programmer. Referér CIF pointer forklaring (præcise sætning).}
\rene{Konsekvenser med/uden pointers.}
