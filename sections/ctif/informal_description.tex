...
\mikael{Skal stadig forklares bedre, men nu er kilderne der.}

Having pointer declarations allows us to reference arrays and array index expressions, even though we cannot initialize an array.
...
This is a form of label polymorphism, as the return label of \dlmc{strcmp2} will always depend on the calling arguments \dlmc{s1} and \dlmc{s2}, which can differ between actual calls.
