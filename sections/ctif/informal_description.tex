...
We make use of the \dlmc{principal} declaration in the example to simulate the actual obtaining of system principals.

\subsection{Function declarations}
The first thing we would want to label in a program is what can be seen as the bigger components; the functions that either obtain data from outside or send data to outside the program -- our channels.\mikael{Omformuler så det handler om channels.}
