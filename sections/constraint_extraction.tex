...
\iF & : \iDecf \rightarrow (\iEnvL \times \iEnvF \rightarrow \iCstr \times \iEnvL \times \iEnvF) \\
...
& \iD\dblSq{D_F} \; \ienvL \; \ienvF = (\icstr, \ienvL_2, \ienvF_2) \dsWhere{\iF\dblSq{D_F} \; \ienvL \; \ienvF = (\icstr, \ienvL_2, \ienvF_2)} \rspace
...
\begin{align*}
  % with expression
  & \iV\dblSq{t \; L \; x \tk = E} \; \ienvL \; \ienvF = (\icstr \cup \{ c \}, \ienvL[x \mapsto \ilv_x]) \\
  & \dsWhere{\iL\dblSq{L} \; \ienvL = \ilv} \\
  & \dsAnd{\iE\dblSq{E} \; \ienvL \; \ienvF = (\icstr, \ilv_E)} \\
