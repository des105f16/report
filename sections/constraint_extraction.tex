...
\iD & : \iDec \rightarrow (\iEnvL \times \iEnvP \rightarrow \iCstr \times \iEnvL \times \iEnvP) \\
\iV & : \iDecv \rightarrow (\iEnvL \times \iEnvP \rightarrow \iCstr \times \iEnvL) \\
\iF & : \iDecf \rightarrow (\iEnvL \times \iEnvP \rightarrow \iCstr \times \iEnvL \times \iEnvP) \\
\iS & : \iStm \rightarrow (\iEnvL \times \iEnvP \rightarrow \iCstr \times \iEnvL) \\
\iE & : \iExp \rightarrow (\iEnvL \times \iEnvP \rightarrow \iCstr \times \iLV) \\
...
\begin{align*}
& \iR\dblSq{D} = \icstr \dsWhere{\iD\dblSq{D} (empty\ienvL, empty\ienvP) = (\icstr, \ienvL, \ienvP)} \rspace
& \iD\dblSq{D_V} \; \ienvL \; \ienvP = (\icstr, \ienvL_2, \ienvP) \dsWhere{\iV\dblSq{D_V} \; \ienvL \; \ienvP = (\icstr, \ienvL_2)} \rspace
& \iD\dblSq{D_F} \; \ienvL \; \ienvP = (\icstr, \ienvL_2, \ienvP_2) \dsWhere{\iF\dblSq{D_F} \; \ienvL \; \ienvP = (\icstr, \ienvL_2, \ienvP_2)} \rspace
& \iD\dblSq{D_1 \; D_2} \; \ienvL \; \ienvP = (\icstr \cup \icstr_2, \ienvL_3, \ienvP_3) \\
& \quad \text{ where } \iD\dblSq{D_2} \; \ienvL_2 \; \ienvP_2 = (\icstr_2, \ienvL_3, \ienvP_3) \\
& \quad \text{ and } \iD\dblSq{D_1} \ienvL \; \ienvP = (\icstr, \ienvL_2, \ienvP_2)
\end{align*}
...
\begin{align*}
% with expression
& \iV\dblSq{t \; L \; x \tk = E} \; \ienvL \; \ienvP = (\icstr \cup \{ c \}, \ienvL[x \mapsto \ilv_x]) \\
& \dsWhere{\iL\dblSq{L} \; \ienvL = \ilv} \\
& \dsAnd{\iE\dblSq{E} \; \ienvL \; \ienvP = (\icstr, \ilv_E)} \\
...
% no expression
& \iV\dblSq{t \; L \; x} \; \ienvL \; \ienvP = (\{ c \}, \ienvL[x \mapsto \ilv_x])\\
& \dsWhere{\iL\dblSq{L} \; \ienvL = \ilv} \\
& \dsAnd{\ilv_x = \begin{cases}
    v(x) & \quad \text{if } \ilv = \varepsilon \\
    \ilv & \quad \text{otherwise}
