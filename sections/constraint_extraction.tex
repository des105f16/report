...
In this section we will give a formal definition of how labels and constraints are extracted from a \thelang~ program.
We will first define our syntactic and semantic constituents, which will form the rules for how constraints are extracted from a \thelang~ program.
