...
\mikaelin{Unfinished business, probably does not make sense.}
\end{definition}
...
\begin{itemize}
  ...
  This is the case we will end up in when considering a program with invalid information flow and only explicit labels.\mikael{Og hvis vi har en constant label på venstre-siden, vel?}
\end{itemize}
