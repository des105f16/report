...
Below we provide definitions for these operations, such that they can be applied 
...
Similarly the meet operation, denoted by $\sqcap$, represents the most restrictive label that is no more restrictive than either operand.
