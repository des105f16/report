...
By adding all principals to the owner set of $L_c$, the first criteria will always hold, and the $\sqsubseteq$ relation will effectively only be a comparison of readers.
