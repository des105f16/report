...
\rene{Begræns scope her: principal hierarchy og evt. andet}
...
\renein{Reference til bevis/påstand for lattice egenskab}
\mikkelin[Hvordan?]{Kan vi referere til DLM, hvor det ikke bevises men blot nævnes eller bør vi inkludere et bevis? Jeg går ud fra at vi skal vise \textit{Commutative, Associative, Absorption, Identity} ?}
